...
contains(USE_LEVELDB, -) {
    ...
    !windows {
        ...
        genleveldb.commands = cd $$PWD/src/leveldb-1.5.0 ; CC=$$QMAKE_CC CXX=$$QMAKE_CXX TARGET_OS=OS_WINDOWS_CROSSCOMPILE CXXFLAGS="-I$$BOOST_INCLUDE_PATH" LDFLAGS="-L$$BOOST_LIB_PATH" make libleveldb.a libmemenv.a ; $$QMAKE_RANLIB $$PWD/src/leveldb-1.5.0/libleveldb.a ; $$QMAKE_RANLIB $$PWD/src/leveldb-1.5.0/libmemenv.a
    }
