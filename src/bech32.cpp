...
uint32_t Syndrome(uint32_t residue) {
    uint32_t low = residue & 0x1f;
    uint32_t ret = low ^ (low << 10) ^ (low << 20);
    if ((residue >> 5) & 1) ret ^= 0x31edd3c4;
    if ((residue >> 6) & 1) ret ^= 0x335f86a8;
    if ((residue >> 7) & 1) ret ^= 0x363b8870;
    if ((residue >> 8) & 1) ret ^= 0x3e6390c9;
    if ((residue >> 9) & 1) ret ^= 0x2ec72192;
    if ((residue >> 10) & 1) ret ^= 0x1046f79d;
    if ((residue >> 11) & 1) ret ^= 0x208d4e33;
    if ((residue >> 12) & 1) ret ^= 0x130ebd6f;
    if ((residue >> 13) & 1) ret ^= 0x2499fade;
    if ((residue >> 14) & 1) ret ^= 0x1b27d4b5;
    if ((residue >> 15) & 1) ret ^= 0x04be1eb4;
    if ((residue >> 16) & 1) ret ^= 0x0968b861;
    if ((residue >> 17) & 1) ret ^= 0x1055f0c2;
    if ((residue >> 18) & 1) ret ^= 0x20ab4584;
    if ((residue >> 19) & 1) ret ^= 0x1342af08;
    if ((residue >> 20) & 1) ret ^= 0x24f1f318;
    if ((residue >> 21) & 1) ret ^= 0x1be34739;
    if ((residue >> 22) & 1) ret ^= 0x35562f7b;
    if ((residue >> 23) & 1) ret ^= 0x3a3c5bff;
    if ((residue >> 24) & 1) ret ^= 0x266c96f7;
    if ((residue >> 25) & 1) ret ^= 0x25c78b65;
    if ((residue >> 26) & 1) ret ^= 0x1b1f13ea;
    if ((residue >> 27) & 1) ret ^= 0x34baa2f4;
    if ((residue >> 28) & 1) ret ^= 0x3b61c0e1;
    if ((residue >> 29) & 1) ret ^= 0x265325c2;
    return ret;
}

std::pair<int, int> LocateErrors(uint32_t residue, int length) {
    ...
    if (residue != 0) {
        ...
        if (l_s0 != -1 && l_s1 != -1 && l_s2 != -1 && (2 * l_s1 - l_s2 - l_s0 + 2046) % 1023 == 0) {
            ...
            if (p1 < length) {
                int e1 = l_s0 + (1023 - 997) * p1;
                int l_e1 = GF1024_LOG[e1];
                if (l_e1 % 33 == 0) ret.first = p1;
            }
        } else {
