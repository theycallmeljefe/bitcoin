...
void TransformD64(unsigned char* out, const unsigned char* in)
{
    ...
    Round(c, d, e, f, g, h, a, b, 0x06ca6351 + (w14 = sigma1(w12) + w7 + 0x400022));
...
void TransformS32(unsigned char* out, const unsigned char* in)
{
    // Transform 1
    uint32_t a = 0x6a09e667ul;
    uint32_t b = 0xbb67ae85ul;
    ...
    Round(a, b, c, d, e, f, g, h, 0x428a2f98 + (w0 = ReadBE32(in)));
    Round(h, a, b, c, d, e, f, g, 0x71374491 + (w1 = ReadBE32(in + 4)));
    Round(g, h, a, b, c, d, e, f, 0xb5c0fbcf + (w2 = ReadBE32(in + 8)));
    Round(f, g, h, a, b, c, d, e, 0xe9b5dba5 + (w3 = ReadBE32(in + 12)));
    Round(e, f, g, h, a, b, c, d, 0x3956c25b + (w4 = ReadBE32(in + 16)));
...
void SHA256S32(unsigned char* out, const unsigned char* in)
{
    sha256::TransformS32(out, in);
}
