...
BOOST_AUTO_TEST_CASE(bloom_create_insert_serialize)
{
    ...
    vector<unsigned char> vch = ParseHex("03b11c8a0500000000000000");
...
BOOST_AUTO_TEST_CASE(bloom_create_insert_serialize_with_tweak)
{
    ...
    CBloomFilter filter(3, 0.01, 100);
    ...
    vector<unsigned char> vch = ParseHex("032ea1820500000064000000");
    vector<char> expected(vch.size());
...
BOOST_AUTO_TEST_CASE(bloom_create_insert_key)
{
    ...
    vector<unsigned char> vch = ParseHex("036b1a610800000000000000");
    vector<char> expected(vch.size());
...
BOOST_AUTO_TEST_CASE(merkle_block_1)
{
    ...
    BOOST_CHECK(merkleBlock.header.vtx.empty());
