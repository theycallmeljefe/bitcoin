...
{
private:
    mutable Consensus::ThresholdConditionCache cache;
...
public:
    ...
    void TestDefined(const CBlockIndex* pindexPrev, int num) const { BOOST_CHECK_MESSAGE(GetStateFor(pindexPrev, paramsDummy, cache) == Consensus::DEFINED, strprintf("Test %i for DEFINED", num)); }
    void TestStarted(const CBlockIndex* pindexPrev, int num) const { BOOST_CHECK_MESSAGE(GetStateFor(pindexPrev, paramsDummy, cache) == Consensus::STARTED, strprintf("Test %i for STARTED", num)); }
    void TestLockedIn(const CBlockIndex* pindexPrev, int num) const { BOOST_CHECK_MESSAGE(GetStateFor(pindexPrev, paramsDummy, cache) == Consensus::LOCKEDIN, strprintf("Test %i for LOCKEDIN", num)); }
    void TestActive(const CBlockIndex* pindexPrev, int num) const { BOOST_CHECK_MESSAGE(GetStateFor(pindexPrev, paramsDummy, cache) == Consensus::ACTIVE, strprintf("Test %i for ACTIVE", num)); }
    void TestFailed(const CBlockIndex* pindexPrev, int num) const { BOOST_CHECK_MESSAGE(GetStateFor(pindexPrev, paramsDummy, cache) == Consensus::FAILED, strprintf("Test %i for FAILED", num)); }
};
