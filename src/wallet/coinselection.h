...
public:
    ...
    CInputCoin(const CTransactionRef& tx, unsigned int i, int input_bytes, std::pair<int64_t,int64_t> input_weights) : CInputCoin(tx, i)
    {
    ...
    int m_input_bytes{-1};
    std::pair<int64_t,int64_t> m_input_weights{-1,-1};
