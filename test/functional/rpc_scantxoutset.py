...
class ScantxoutsetTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(self.nodes[0].scantxoutset("start", [ "old(" + pubk1 + ")", "old(" + pubk2 + ")", "old(" + pubk3 + ")"])['total_amount'], 6)
        assert_equal(self.nodes[0].scantxoutset("start", [ "addr(" + addr_P2SH_SEGWIT + ")", "addr(" + addr_LEGACY + ")", "addr(" + addr_BECH32 + ")"])['total_amount'], 6)
        assert_equal(self.nodes[0].scantxoutset("start", [ "addr(" + addr_P2SH_SEGWIT + ")", "addr(" + addr_LEGACY + ")", "old(" + pubk3 + ")"])['total_amount'], 6)
